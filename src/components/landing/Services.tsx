...
const services: Service[] = [
  {
    ...
    professions: [
      ...
      { name: "Мерчандайзер", price: "от 2 000 ₽/смена" },
      { name: "Продавец-консультант", price: "от 2 200 ₽/смена" },
  ...
  },
  {
    ...
    professions: [
      ...
      { name: "Комплектовщик", price: "от 2 200 ₽/смена" },
      { name: "Упаковщик", price: "от 1 800 ₽/смена" },
      { name: "Оператор ПТО", price: "от 2 800 ₽/смена" },
    ],
  },
  {
    ...
    professions: [
      { name: "Повар", price: "от 2 500 ₽/смена" },
      { name: "Официант", price: "от 1 800 ₽/смена" },
      { name: "Посудомойщик", price: "от 1 500 ₽/смена" },
      { name: "Помощник на кухне", price: "от 1 600 ₽/смена" },
    ],
  },
  {
    icon: SprayCan,
    ...
    professions: [
      { name: "Уборщик помещений", price: "от 1 500 ₽/смена" },
      { name: "Мойщик окон", price: "от 2 000 ₽/смена" },
      { name: "Дворник", price: "от 1 400 ₽/смена" },
      { name: "Техник по обслуживанию", price: "от 2 200 ₽/смена" },
    ],
  },
  {
    icon: Truck,
    ...
    professions: [
      { name: "Курьер пеший", price: "от 2 000 ₽/смена" },
      { name: "Курьер на авто", price: "от 3 000 ₽/смена" },
      { name: "Водитель категории B", price: "от 3 500 ₽/смена" },
      { name: "Экспедитор", price: "от 2 800 ₽/смена" },
    ],
  },
  {
    icon: Headphones,
    ...
    professions: [
      { name: "Оператор колл-центра", price: "от 1 800 ₽/смена" },
      { name: "Оператор ввода данных", price: "от 1 600 ₽/смена" },
      { name: "Секретарь", price: "от 2 000 ₽/смена" },
      { name: "Промоутер по телефону", price: "от 1 700 ₽/смена" },
    ],
  },
  {
    icon: HardHat,
    ...
    professions: [
      ...
      { name: "Маляр", price: "от 2 500 ₽/смена" },
      { name: "Бетонщик", price: "от 2 800 ₽/смена" },
    ],
  },
  {
    icon: Wheat,
    ...
    professions: [
      ...
      { name: "Рабочий теплицы", price: "от 1 600 ₽/смена" },
      { name: "Упаковщик продукции", price: "от 1 500 ₽/смена" },
      { name: "Тракторист", price: "от 3 000 ₽/смена" },
    ],
  },
  {
    icon: Shield,
    title: "Охрана и обслуживание",
    desc: "Базовая охрана объектов, контроль доступа",
    professions: [
      { name: "Охранник", price: "от 2 200 ₽/смена" },
      { name: "Контролёр на проходной", price: "от 2 000 ₽/смена" },
      { name: "Сторож", price: "от 1 800 ₽/смена" },
      { name: "Оператор видеонаблюдения", price: "от 2 000 ₽/смена" },
    ],
  },
];
